...
| `frontend/design_v2/PHASE_14E2A_ACTIVE_VISIT_BROWSER_ACCEPTANCE_RECORD.md` | IMPLEMENTATION_RECORD | Active Visit acceptance evidence | Deterministic local browser acceptance record; it does not redefine product behavior. |
