...
| `frontend/design_v2/{PHASE_14E2A_ACTIVE_VISIT_BROWSER_ACCEPTANCE_RECORD,PHASE_14E3_BILLING_INVOICE_PAYMENT_WORKSPACE_IMPLEMENTATION_RECORD}.md` | IMPLEMENTATION_RECORD | Active Visit and Billing acceptance evidence | Deterministic local acceptance records; they do not redefine product behavior. |
