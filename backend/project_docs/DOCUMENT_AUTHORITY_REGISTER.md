...
**Owner / next responsibility:** Phase 14F.1 corrected visual-system governance; every future feature owner updates only the rows affected by approved work.
...
| `frontend/design_v2/{PHASE_14C_IMPLEMENTATION_RECORD,PHASE_14D_BROWSER_ACCEPTANCE_RECORD,PHASE_14D1_TEAM_USERS_ACCESS_IMPLEMENTATION_RECORD,PHASE_14D2_ROLE_DASHBOARD_IMPLEMENTATION_RECORD,PHASE_14D3_APPOINTMENTS_IMPLEMENTATION_RECORD,PHASE_14D3A_APPOINTMENTS_CLOSURE_RECORD,PHASE_14D4_PATIENT_WORKSPACE_IMPLEMENTATION_RECORD,PHASE_14D4A_PATIENT_CLOSURE_RECORD,PHASE_14E1_ACTION_HIERARCHY_IMPLEMENTATION_RECORD,PHASE_14E1A_COLLECTION_ACTION_CLOSURE_RECORD,PHASE_14E2_ACTIVE_VISIT_CLINICAL_WORKSPACE_IMPLEMENTATION_RECORD,LOCAL_LOGIN_NETWORK_FIX_RECORD}.md` | IMPLEMENTATION_RECORD | Related troubleshooting only | Evidence of delivered work; must not redefine product behavior. |
| `frontend/design_v2/{PHASE_14E2A_ACTIVE_VISIT_BROWSER_ACCEPTANCE_RECORD,PHASE_14E3_BILLING_INVOICE_PAYMENT_WORKSPACE_IMPLEMENTATION_RECORD,PHASE_14E3A_DOCUMENTATION_VALIDATION_CLOSURE_RECORD,PHASE_14E4_XRAY_AI_WORKSPACE_IMPLEMENTATION_RECORD}.md` | IMPLEMENTATION_RECORD | Active Visit, Billing, X-ray/AI, and validation evidence | Deterministic local evidence; they do not redefine product behavior. |
