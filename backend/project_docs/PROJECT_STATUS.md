...
Phase 14D automated acceptance is complete. Phase 14E is in progress: Schedules and Leave, Visits, and X-rays/AI are complete with 43 frontend files / 157 tests, 83 focused schedule/leave backend tests, 248 focused visit backend tests, and 131 focused X-ray/AI backend tests. Billing, Clinic Settings, and Audit have not started. Browser QA remains the explicitly deferred Phase 14F visual/UAT gate. The backend API, permissions, serializers, models, and migrations remain unchanged; backend runtime changed: no; migrations: none.
