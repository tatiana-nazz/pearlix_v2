...
- X-rays and AI: Phase 13H integrates authenticated Blob media rendering, saved X-ray list/detail/upload, returned result disclaimers and overlays, and Admin/Doctor external workspace routes. The mock adapter remains current; disabled real-service modes return `AI_SERVICE_NOT_CONFIGURED`.
