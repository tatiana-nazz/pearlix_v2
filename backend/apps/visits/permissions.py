...
class VisitPermission(BasePermission):
    doctor_actions = {"active", "complete", "clinical_notes", "xrays", "billing_handoff", "create_invoice", "invoice"}
    ...
    def has_object_permission(self, request, view, obj) -> bool:
        if view.action in {"complete", "clinical_notes", "xrays", "billing_handoff", "create_invoice", "invoice"}:
