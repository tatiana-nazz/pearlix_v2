...
| patient workspace | Refined | localized directory, General Information creation, read-first profile, explicit medical-history form, accessible tabs 14D.4 | retains backend pagination, permissions, versioning, archive actions, and bounded related summaries; browser verification remains pending. |
