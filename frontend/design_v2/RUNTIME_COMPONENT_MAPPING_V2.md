...
| appointment components | Refactored | v2 appointments workspace, date navigation, calendar/list, detail, and reschedule components 14D.3 | uses server filters/availability and role-aware actions; base/queue navigation exact matching; retain existing route compatibility while patients remain Phase 14D work. |
