...
import { CalendarClock, CalendarDays, CalendarOff, ImagePlus, LayoutDashboard, ReceiptText, ScanLine, ScrollText, Settings, ShieldCheck, Stethoscope, UsersRound } from "lucide-react";
