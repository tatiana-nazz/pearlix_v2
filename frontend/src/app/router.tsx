...
import { BillingHandoffDetailPage, BillingHandoffListPage, BillingOverviewPage, InvoiceDetailPage, InvoiceListPage, InvoicePrintPage } from "../pages/billing/BillingPages";
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { path: "billing/handoffs/new", element: <Navigate to="/staff/billing/handoffs" replace /> },
              ...
              { path: "billing/invoices/new", element: <Navigate to="/staff/billing/handoffs" replace /> },
