...
const statusMeta: Record<string, { tone:string; icon:typeof Circle }> = {
  ACTIVE:{ tone:"success", icon:CheckCircle2 }, AVAILABLE:{ tone:"success", icon:CheckCircle2 }, COMPLETED:{ tone:"success", icon:CheckCircle2 }, FLAGGED:{ tone:"success", icon:CheckCircle2 }, PAID:{ tone:"success", icon:CheckCircle2 },
  UPCOMING:{ tone:"info", icon:Info }, CHECKED_IN:{ tone:"info", icon:Info }, PROCESSING:{ tone:"info", icon:Info },
  ON_LEAVE:{ tone:"warning", icon:AlertCircle }, AVAILABLE_OVERRIDE:{ tone:"warning", icon:AlertCircle }, NEEDS_RESCHEDULE:{ tone:"warning", icon:AlertCircle }, PARTIALLY_PAID:{ tone:"warning", icon:AlertCircle }, PENDING:{ tone:"warning", icon:AlertCircle }, REVIEW:{ tone:"warning", icon:AlertCircle },
