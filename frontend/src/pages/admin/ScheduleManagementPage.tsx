...
export function ScheduleManagementPage() {
  ...
  const clinicClosedNote = (weekday: number) => isClinicClosed(weekday) ? <strong className="schedule-closed-note">Clinic closed · shift stored</strong> : null;
