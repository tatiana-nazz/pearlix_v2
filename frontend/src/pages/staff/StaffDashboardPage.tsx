...
import { AppointmentPreview, DashboardAction, DashboardError, DashboardLoading, Icons, InvoicePreview, Kpis, useClinicDashboardDate } from "../dashboard/DashboardV2";
