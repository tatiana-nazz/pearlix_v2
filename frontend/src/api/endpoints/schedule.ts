...
export const scheduleApi = {
  ...
  defaultShifts: () => api.get<Page<ClinicDefaultShift>>("/clinic-default-shifts/"),
  createDefaultShift: (payload: Omit<ClinicDefaultShift, "id" | "is_active" | "version" | "created_at" | "updated_at" | "created_by" | "updated_by" | "weekday_label">) => api.post<ClinicDefaultShift>("/clinic-default-shifts/", payload),
  ...
  workingShifts: (query?: QueryParams) => api.get<Page<WorkingShift>>("/working-shifts/", query),
